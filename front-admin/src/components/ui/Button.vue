...
const buttonVariants = cva(
  ...
  // Focus ring if necessary -> "focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 dark:focus:ring-slate-400 dark:focus:ring-offset-slate-900"
  {
    variants: {
      variant: {
        default:
          'bg-palette-primary-500 text-white hover:bg-palette-primary-600 border  border-palette-primary-500 dark:bg-palette-primary-400 dark:hover:bg-palette-primary-600 dark:text-white',
